...
export default function SliderMobile() {
  ...
  return (
    <div className="bg-[linear-gradient(80.42deg,rgba(0,0,0,0.16)_25.25%,rgba(83,84,108,0.16)_98.05%)] border-[1px] border-border rounded-[20px] w-[90%] py-[0px] px-[40px]">
      <Carousel
        opts={{
          align: "start",
        }}
        className="w-full min-[1444px]:w-[1300px] lg:bg-[linear-gradient(79.59deg,_rgba(51,51,62,0.16)_6.21%,_rgba(83,84,108,0.16)_98.02%)] px-3 lg:px-6 py-0 lg:py-3 rounded-[20px]"
      >
