...
import footerimgMobile from '../../public/landing/FooterImg.png'
    ...
    <div>
      <div className="relative ">
        <Image
          ...
          width={400}
          height={760}
          className="absolute top-0 left-0 opacity-30 max-lg:hidden max-h-[760px] h-full"
          alt="left flow"
          priority
        />
        <img
      ...
      <div className="container relative z-50 mt-[30px] lg:mt-[-40px] flex justify-center lg:justify-between items-center">
        ...
        <p className="font-sabor whitespace-nowrap text-[30px] md:text-[60px] lg:text-[40px] 2xl:text-[60px] leading-none max-md:text-center">
          ...
          <p className="text-[25px] lg:text-[25px] 2xl:text-[30px] font-sabor max-w-[740px] my-6 max-md:text-center">
          ...
          <div className="max-md:justify-center max-md:flex max-md:items-center">
            <GradientBtn text="Book a Call" url="https://calendly.com/yasir-programmx/30min" />
          </div>
        </div>
        <div>
          <Image
      ...
      <Separator className="hidden lg:block mt-[30px]  lg:mt-[100px]  mx-auto z-50" />
      <div className="w-full mt-[40px] lg:mt-0 px-4 md:px-8 container flex flex-col md:justify-center md:items-center gap-[4vw] max-md:pb-3 relative">
        <Image
          src={footerCenterBg}
          width={744}
          height={900}
        ...
        {/* <Image
          ...
          priority
        /> */}
      {/*   <img src="/landing/FooterImg.png" alt="footer" className="opacity-40 absolute z-0 bottom-0 left-0 right-0 "/> */}
        <div className="w-full flex flex-col md:flex-row gap-[-5vw]  relative z-50">
            ...
            <div className="md:hidden text-lg text-[#C6C6C6] text-right  pt-[4.2vw] font-sabor">
              ...
              <div className="flex px-4 justify-between lg:justify-center gap-[1vw] text-white container pt-[4.2vw] md:hidden font-sabor">
                ...
                <div className="flex flex-col text-start items-start gap-y-2">
                  ...
                  <p className="text-base sm:text-[20px] cursor-pointer">
          ...
          <div className="flex  justify-start md:justify-end gap-[6vw] md:pt-[9.9vw] w-full">
            ...
            <div className="flex md:flex-col gap-[3vw] md:gap-[2vw] max-md:mb-3 max-md:mt-7 max-md:hidden">
              <p className="text-[0.91rem] sm:text-[200px] md:text-[1.736vw] MHD:text-[35px] font-700  font-sabor font-bold mx-0  whitespace-nowrap">
                Follow Us
              </p>
              <div className="flex md:flex-col text-[1.2vw] MHD:text-[20px] font-sabor text-[#E5E5E5] gap-[2vw] md:gap-[0.8vw] ">
              <Link href={"https://www.linkedin.com/company/p-techfusion/"} target="_blank" rel="noopener noreferrer">
        ...
        <div className="relative z-50 w-full flex justify-between gap-[8vw] pb-3  text-[1.442vw] min-[1920px]:text-lg md:text-[1.042vw] text-[#C6C6C6] mx-0 max-md:hidden">
          ...
          <p>Cookie Policy</p> */}
            ...
            <p>|</p>
            <p onClick={scrollToTop} className="cursor-pointer">
              Back To Top
            </p>
          </div>
        </div>
      </div>
      <div className="md:hidden flex flex-col justify-center font-sabor items-center text-center bg-black text-white w-full text-[15px]  py-4 px-4">
        <p>Copyright &copy; 2024 programmX. All Rights Reserved.</p>
