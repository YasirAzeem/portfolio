...
export default function SuccessPFSolution() {
  const leftArrData = [
  ...
  return (
    <div className="relative w-full h-full mt-[50px] sm:mt-[70px] HD:mt-[170px] MHD:mt-[200px] md:mb-[160px] lg:mb-[0] z-[99]">
      <div className="bg-[#1936BA] h-[87.45px] lg:h-[154px] relative z-[99]">
      ...
      {/* <img
        src="/blogresp/faqbgresp.png"
        alt="bg"
        className="md:hidden absolute opacity-80 inset-0 w-full top-0 object-cover z-0 h-[900px] XXSM:h-[980px] sm:h-[950px] left-0"
      /> */}
      <div className="relative ">
        ...
        <Image
          ...
          width={943}
          height={905}
          className="absolute translate-x-[-50%] translate-y-[-50%] top-1/2 left-1/2 z-[99] max-[1200px]:hidden"
          priority
        />
        ...
        <div className="max-md:!hidden absolute translate-x-[-135px] max-[1200px]:translate-y-[240px] translate-y-[190px] top-1/2 left-1/2 z-[99] mt-8">
          <GradientBtn text="Get Started" url="https://calendly.com/yasir-programmx/30min" />
        </div>
        <div className="max-w-[1400px] max-[1200px]:container max-md:gap-3 mt-[40px] lg:mt-[80px] max-[1200px]:gap-4 mx-auto flex max-md:flex-col items-centers justify-between">
          <div className="flex flex-col gap-3  HD:px-4 lg:px-6">
            {leftArrData.map((x, index) => (
              <div key={index + x} className="flex items-start gap-1.5 z-[99]">
                <Image
                  src={check}
                  width={20}
                  height={17}
        ...
        <div className="absolute -bottom-[112px] lg:-bottom-[370px] z-[99] w-full h-[76px] lg:h-[140px] overflow-hidden flex flex-col-reverse">
          {/* <Image
            src={caq}
            width={1920}
            height={149}
          ...
          <p className="text-[25px] font-normal whitespace-nowrap lg:text-[40px] font-sabor absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 text-center ">
            We Deliver world-class digital solutions
          </p>
        </div>
      </div>
    </div>
