...
const data1 = [
  {
    ...
    desc: "Our Vue team offers extensive expertise serving various industries, transforming your ideas into reality with exceptional performance. We’re committed to excellence, elevating your business to the next level. Trust us to provide the highest quality service.",
  },
  {
    title: "Flexible Hiring Models",
    desc: "Our company offers professional Vue developers on flexible pricing models for your project. Our team can easily scale up or down to meet your deadline, delivering quality work that fits your specific needs. Contact us today to start building your dedicated team.",
  },
  {
    title: "Agile Development Method",
    desc: "Our Vue developers use an agile process to manage development time and costs, understand your requirements, and deliver high-quality solutions aligned with your business needs.",
  },
  {
    title: "Flexible Time Zone",
    desc: "Our skilled Vue developers work across multiple time zones to accommodate clients’ unique needs. We offer flexible work schedules to deliver optimal results for your project. Contact us for assistance.",
  },
  {
    title: "Hassle-Free Hiring",
    desc: "Our skilled Vue developers can take on your project without extra training. We excel in project management and guarantee satisfaction with ongoing support. Expect outstanding results.",
  },
  {
    title: "Flexible Time Zone",
    desc: "We offer customized Vue development services including web app development, custom CMS, e-commerce, and more. Our process includes planning, development, testing, and deployment to achieve your business goals. Trust us with complex projects.",
  },
];

const data = [
  {
    title: "Custom Vue Development",
    desc: "Our experienced Vue team delivers exceptional development solutions for businesses of all sizes. Explore our Vue services.",
    img: EnterpriseImg,
  },
  {
  ...
  {
    title: "Vue Framework Development",
    desc: "Our company specializes in the development of web applications utilizing advanced Vue frameworks such as Laravel and CodeIgniter. Our primary objective is to construct Vue web applications that are adaptable and can be scaled to meet the requirements of our clients.",
    img: Integration,
  },
  {
    title: "Vue Upgradation & Migration",
    desc: "Our Vue developers provide customized solutions tailored to your needs – from migration to the latest frameworks and best practices. We collaborate with you, provide regular updates, and deliver reliable, scalable, and robust solutions that boost user engagement. Let’s take your digital journey to the next level together!",
    img: Plugin,
  },
  {
    title: "Maintenance and Support",
    desc: "Our Vue developers offer expert help in keeping your apps running smoothly and safely. Our team has extensive knowledge and experience and can provide top-quality services to meet your needs, from fixing bugs to upgrading Vue versions. Contact us to learn how we can help you maintain your Vue apps with ease and confidence.",
    img: Support,
  },
  {
    title: "Corporate Website Development",
    desc: "Hire Vue developers to create professional web applications like CRM, ERP, and portals. Experts will work efficiently using the latest tools to meet industry standards. Trust qualified developers to deliver high-quality results that meet your business needs and exceed expectations.",
    img: Consulting,
  },
];
...
export default function HireVueDeveloper() {
  return (
    <div className="mx-auto">
      <div className="flex items-center justify-center">
        ...
        <div className="max-w-4xl gap-10 flex ">
          <div className="flex flex-col items-start md:w-1/2">
            <h1 className="text-4xl font-bold mb-4">Hire VueJS Developer</h1>
            <p className="text-lg mb-6 text-left max-w-2xl">
              Our Vue developers offer top-quality web development at
      ...
      <p className="flex justify-center">
        Please select from a range of different Vue developer models to best
      ...
      <div className="mt-[120px] flex justify-center">
        <h1 className="text-4xl font-bold mb-4">
          Schedule An Interview & Hire Vue Developers Now
        </h1>
      </div>
      <p className="flex justify-center">
        We offer customized talent solutions with our team of dedicated Vue
        developers available on-demand.
      </p>

      <div className="mt-[120px] flex justify-center">
        <h1 className="text-4xl font-bold mb-4">
          Hire Vue Developers for 360° Web Development Solutions
        </h1>
      </div>
      <p className="flex justify-center">
        Our experienced Vue team delivers exceptional development solutions for
        businesses of all sizes. Explore our Vue services.
      </p>
      ...
      <h1 className="text-white text-3xl p-20 font-bold mb-6 mt-4 text-center">
        Why Hire Vue Developers from ProgrammX?
      </h1>
      <p className="flex justify-center m-8">
        ProgrammX is a Vue development company that creates customized web
      ...
      <h1 className="text-white text-4xl font-bold  mt-2  text-center">
        Process Flow for Hiring Vue Developers
      </h1>
      ...
      <h1 className="text-white text-4xl font-bold  mt-2  text-center">
        Technology Expertise Of Our Vue Developers
      </h1>
      <p className="flex justify-center ">
        We offer unparalleled Vue development services with skilled developers
