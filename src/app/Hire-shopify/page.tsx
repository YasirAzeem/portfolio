...
const data1 = [
  {
    ...
    desc: "Our Shopify team offers extensive expertise serving various industries, transforming your ideas into reality with exceptional performance. We’re committed to excellence, elevating your business to the next level. Trust us to provide the highest quality service.",
  },
  {
    title: "Flexible Hiring Models",
    desc: "Our company offers professional Shopify developers on flexible pricing models for your project. Our team can easily scale up or down to meet your deadline, delivering quality work that fits your specific needs. Contact us today to start building your dedicated team.",
  },
  {
    title: "Agile Development Method",
    desc: "Our Shopify developers use an agile process to manage development time and costs, understand your requirements, and deliver high-quality solutions aligned with your business needs.",
  },
  {
    title: "Flexible Time Zone",
    desc: "Our skilled Shopify developers work across multiple time zones to accommodate clients’ unique needs. We offer flexible work schedules to deliver optimal results for your project. Contact us for assistance.",
  },
  {
    title: "Hassle-Free Hiring",
    desc: "Our skilled Shopify developers can take on your project without extra training. We excel in project management and guarantee satisfaction with ongoing support. Expect outstanding results.",
  },
  {
    title: "Flexible Time Zone",
    desc: "We offer customized Shopify development services including web app development, custom CMS, e-commerce, and more. Our process includes planning, development, testing, and deployment to achieve your business goals. Trust us with complex projects.",
  },
];
...
const data = [
  {
    ...
    desc: "Our experienced Shopify team delivers exceptional development solutions for businesses of all sizes. Explore our Shopify services.",
    img: EnterpriseImg,
  },
  {
  ...
  {
    title: "Shopify Framework Development",
    desc: "Our company specializes in the development of web applications utilizing advanced Shopify frameworks such as Laravel and CodeIgniter. Our primary objective is to construct Shopify web applications that are adaptable and can be scaled to meet the requirements of our clients.",
    img: Integration,
  },
  {
    title: "Shopify Upgradation & Migration",
    desc: "Our Shopify developers provide customized solutions tailored to your needs – from migration to the latest frameworks and best practices. We collaborate with you, provide regular updates, and deliver reliable, scalable, and robust solutions that boost user engagement. Let’s take your digital journey to the next level together!",
    img: Plugin,
  },
  {
    title: "Maintenance and Support",
    desc: "Our Shopify developers offer expert help in keeping your apps running smoothly and safely. Our team has extensive knowledge and experience and can provide top-quality services to meet your needs, from fixing bugs to upgrading Shopify versions. Contact us to learn how we can help you maintain your Shopify apps with ease and confidence.",
    img: Support,
  },
  {
    title: "Corporate Website Development",
    desc: "Hire Shopify developers to create professional web applications like CRM, ERP, and portals. Experts will work efficiently using the latest tools to meet industry standards. Trust qualified developers to deliver high-quality results that meet your business needs and exceed expectations.",
    img: Consulting,
  },
];
  ...
  return (
    <div className="mx-auto">
      <div className="flex items-center justify-center">
        ...
        <div className="max-w-4xl gap-10 flex ">
          <div className="flex flex-col items-start md:w-1/2">
            <h1 className="text-4xl font-bold mb-4">Hire Shopify Developer</h1>
            <p className="text-lg mb-6 text-left max-w-2xl">
              Our Shopify developers offer top-quality web development at
      ...
      <p className="flex justify-center">
        Please select from a range of different Shopify developer models to best
      ...
      <div className="mt-[120px] flex justify-center">
        <h1 className="text-4xl font-bold mb-4">
          Schedule An Interview & Hire Shopify Developers Now
        </h1>
      </div>
      <p className="flex justify-center">
        We offer customized talent solutions with our team of dedicated Shopify
        developers available on-demand.
      </p>

      <div className="mt-[120px] flex justify-center">
        <h1 className="text-4xl font-bold mb-4">
          Hire Shopify Developers for 360° Web Development Solutions
        </h1>
      </div>
      <p className="flex justify-center">
        Our experienced Shopify team delivers exceptional development solutions for
        businesses of all sizes. Explore our Shopify services.
      </p>
      ...
      <h1 className="text-white text-3xl p-20 font-bold mb-6 mt-4 text-center">
        Why Hire Shopify Developers from ProgrammX?
      </h1>
      <p className="flex justify-center m-8">
        ProgrammX is a Shopify development company that creates customized web
      ...
      <h1 className="text-white text-4xl font-bold  mt-2  text-center">
        Process Flow for Hiring Shopify Developers
      </h1>
      ...
      <h1 className="text-white text-4xl font-bold  mt-2  text-center">
        Technology Expertise Of Our Shopify Developers
      </h1>
      <p className="flex justify-center ">
        We offer unparalleled Shopify development services with skilled developers
